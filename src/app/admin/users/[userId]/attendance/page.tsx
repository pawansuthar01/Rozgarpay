            ...
            <div className="bg-orange-50 rounded-lg border border-orange-200 p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2">
                  <AlertTriangle className="h-5 w-5 text-orange-600" />
                  <h3 className="text-sm font-semibold text-orange-800">
                    Missing ({missingData.missingDates.length})
                  </h3>
                </div>
                {missingTotalPages > 1 && (
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      disabled={missingPage === 1}
                      className="p-1 rounded bg-orange-200 disabled:opacity-50"
                    >
                      <ChevronLeft className="h-4 w-4 text-orange-700" />
                    </button>
                    <span className="text-xs text-orange-700">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">No attendance</p>
                      </div>
                      <div className="flex space-x-1">
                        <button
                          onClick={() =>
                            handleMarkMissingAttendance(
                              missing.date,
                              "APPROVED",
                            )
                          }
